...
import com.github.liuyehcf.framework.rule.engine.dsl.compile.semantic.element.AddGlobalListeners;
import com.github.liuyehcf.framework.rule.engine.dsl.compile.semantic.element.InitListenerList;
import com.github.liuyehcf.framework.rule.engine.dsl.compile.semantic.iterator.PushIteratorRule;
...
abstract class ProgramProductions {
    ...
    static final Production[] PRODUCTIONS = {
            ...
            Production.create(
                    /*
                     * <programs> →  <mark create rule> <block> <epsilon or global listeners>
                     */
                    PrimaryProduction.create(
                            Symbol.createNonTerminator(PROGRAMS),
                            SymbolString.create(
                                    Symbol.createNonTerminator(MARK_CREATE_RULE),
