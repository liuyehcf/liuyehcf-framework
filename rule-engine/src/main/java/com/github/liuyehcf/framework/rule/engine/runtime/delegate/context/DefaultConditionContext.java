...
public class DefaultConditionContext extends AbstractExecutableContext<Condition> implements ConditionContext {
    ...
    public DefaultConditionContext(Element element, String instanceId, String linkId, long executionId, Map<String, Object> env, Map<String, Attribute> globalAttributes, Promise<ExecutionInstance> rulePromise) {
