...
public class VariableLoad extends AbstractSemanticAction implements Serializable {
    ...
    public void onAction(HuaContext context) {
        ...
        if (type.isArrayType()) {
            ...
            context.addByteCodeToCurrentMethod(new _aload(variableSymbol.getOrder(), variableSymbol.getOffset()));
            ...
            switch (type.getTypeName()) {
                case NORMAL_BOOLEAN:
                case NORMAL_INT:
                    context.addByteCodeToCurrentMethod(new _iload(variableSymbol.getOrder(), variableSymbol.getOffset()));
                    context.setAttrToLeftNode(AttrName.TYPE, type);
                    break;
                default:
