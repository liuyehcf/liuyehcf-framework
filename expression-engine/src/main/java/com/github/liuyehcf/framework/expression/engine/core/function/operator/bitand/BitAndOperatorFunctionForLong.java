package com.github.liuyehcf.framework.expression.engine.core.function.operator.bitand;
 ...
 * @date 2018/9/29
 */
public class BitAndOperatorFunctionForLong extends BitAndOperatorFunction {
    @Override
