 ...
 * @date 2019/4/25
 */
public class DefaultRule extends AbstractNode implements Rule {
    ...
    public DefaultRule(String name, String id, Start start) {
        this(name, id, LinkType.NORMAL, start);
    }

    public DefaultRule(String name, String id, LinkType linkType, Start start) {
    ...
    private void checkListener() {
        ...
        Assert.assertEquals(nodeListenerNum, nodeListeners.size(),
                () -> String.format("listener relationship asymmetry. nodeListenerNum=%s, ruleNodeListenerNum=%s", nodeListeners.size(), nodeListenerNum));
    }
