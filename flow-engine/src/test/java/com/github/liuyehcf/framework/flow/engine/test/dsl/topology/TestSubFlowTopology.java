...
public class TestSubFlowTopology extends TestBaseTopology {
    ...
    public void testSubParallelWithAction() {
        ...
        Flow subFlow1 = (Flow) actionA.getSuccessors().get(0);
        assertFlow(subFlow1, LinkType.NORMAL, 0, 2, 0, 0, 4, actionA);

        Start subStart1 = subFlow1.getStart();
        ...
        assertFlow(flow, LinkType.NORMAL, 0, 3, 0, 0, 5, null);
    }
    ...
    public void testSubCascadeWithAction() {
        ...
        Flow subFlow1 = (Flow) actionZ.getSuccessors().get(0);
        assertFlow(subFlow1, LinkType.NORMAL, 0, 7, 0, 0, 15, actionZ);
    ...
    public void testSubContainComplex() {
        ...
        Flow subFlow = (Flow) start.getSuccessors().get(0);
        assertFlow(subFlow, LinkType.NORMAL, 0, 2, 0, 0, 10, start);

        Start subStart = subFlow.getStart();
    ...
    public void testSubContainComplexWithListener() {
        ...
        Flow subFlow = (Flow) start.getSuccessors().get(0);
        assertFlow(subFlow, LinkType.NORMAL, 0, 2, 20, 0, 30, start);
        ...
        assertFlow(flow, LinkType.NORMAL, 0, 1, 2, 0, 4, null);
    }
    ...
    public void testSubNestedInIfThen() {
        ...
        Flow subFlow1 = (Flow) conditionA.getSuccessors().get(1);
        assertFlow(subFlow1, LinkType.TRUE, 0, 1, 0, 0, 2, conditionA);
    ...
    public void testSubNestedInIfThenElse() {
        ...
        Flow subFlow2 = (Flow) conditionA.getSuccessors().get(4);
        assertFlow(subFlow2, LinkType.FALSE, 0, 1, 0, 0, 2, conditionA);

        Start subStart2 = subFlow2.getStart();
    ...
    public void testSubThenCascadeAndParallelWithAction() {
        ...
        Flow subFlow1 = (Flow) actionA.getSuccessors().get(0);
        assertFlow(subFlow1, LinkType.NORMAL, 1, 2, 0, 0, 4, actionA);
        ...
        Action actionE = (Action) subFlow1.getSuccessors().get(0);
        assertActivity(actionE, LinkType.TRUE, "actionE", 0, 0, 0, 0, subFlow1);
        ...
        assertFlow(flow, LinkType.NORMAL, 0, 3, 0, 0, 6, null);
    }
    ...
    public void testSubThenCascadeWithAction() {
        ...
        Flow subFlow1 = (Flow) actionZ.getSuccessors().get(0);
        assertFlow(subFlow1, LinkType.NORMAL, 1, 7, 0, 0, 15, actionZ);
        ...
        Action actionO = (Action) subFlow1.getSuccessors().get(0);
        assertActivity(actionO, LinkType.TRUE, "actionO", 0, 0, 0, 0, subFlow1);
    ...
    public void testSubThenContainJonAndSelect() {
        ...
        Flow subFlow = (Flow) start.getSuccessors().get(0);
        assertFlow(subFlow, LinkType.NORMAL, 1, 2, 0, 0, 10, start);
        ...
        Action actionD = (Action) subFlow.getSuccessors().get(0);
        assertActivity(actionD, LinkType.TRUE, "actionD", 0, 0, 0, 0, subFlow);
    ...
    public void testSubThenContainJoinAndSelectWithListener() {
        ...
        Flow subFlow = (Flow) start.getSuccessors().get(0);
        assertFlow(subFlow, LinkType.NORMAL, 1, 2, 20, 0, 30, start);
        ...
        Action actionD = (Action) subFlow.getSuccessors().get(0);
        assertActivity(actionD, LinkType.TRUE, "actionD", 0, 0, 2, 0, subFlow);
        ...
        assertFlow(flow, LinkType.NORMAL, 0, 1, 4, 0, 7, null);
    }
    ...
    public void testSubThenNextedIfIfThen() {
        ...
        Flow subFlow1 = (Flow) conditionA.getSuccessors().get(1);
        assertFlow(subFlow1, LinkType.TRUE, 1, 1, 0, 0, 2, conditionA);
        ...
        Action actionC = (Action) subFlow1.getSuccessors().get(0);
        assertActivity(actionC, LinkType.TRUE, "actionC", 0, 0, 0, 0, subFlow1);
    ...
    public void testSubThenNestedInIfThenElse() {
        ...
        Flow subFlow2 = (Flow) conditionA.getSuccessors().get(4);
        assertFlow(subFlow2, LinkType.FALSE, 1, 1, 0, 0, 2, conditionA);
        ...
        Action actionG = (Action) subFlow2.getSuccessors().get(0);
        assertActivity(actionG, LinkType.TRUE, "actionG", 0, 0, 0, 0, subFlow2);

        Action actionH = (Action) conditionA.getSuccessors().get(5);
        assertActivity(actionH, LinkType.FALSE, "actionH", 0, 0, 0, 0, conditionA);

        assertFlow(flow, LinkType.NORMAL, 0, 6, 0, 0, 10, null);
    }
    ...
    public void testSubThenElseCascadeAndParallelWithAction() {
        ...
        Flow subFlow1 = (Flow) actionA.getSuccessors().get(0);
        assertFlow(subFlow1, LinkType.NORMAL, 2, 2, 0, 0, 4, actionA);
        ...
        Action actionF = (Action) subFlow1.getSuccessors().get(1);
        assertActivity(actionF, LinkType.FALSE, "actionF", 0, 0, 0, 0, subFlow1);
    ...
    public void testSubThenElseCascadeWithAction() {
        ...
        Flow subFlow1 = (Flow) actionZ.getSuccessors().get(0);
        assertFlow(subFlow1, LinkType.NORMAL, 2, 7, 0, 0, 15, actionZ);
        ...
        Action actionP = (Action) subFlow1.getSuccessors().get(1);
        assertActivity(actionP, LinkType.FALSE, "actionP", 0, 0, 0, 0, subFlow1);
    ...
    public void testSubThenElseContainJoinAndSelect() {
        ...
        Flow subFlow = (Flow) start.getSuccessors().get(0);
        assertFlow(subFlow, LinkType.NORMAL, 2, 2, 0, 0, 10, start);
        ...
        Action actionE = (Action) subFlow.getSuccessors().get(1);
        assertActivity(actionE, LinkType.FALSE, "actionE", 0, 0, 0, 0, subFlow);
    ...
    public void testSubThenElseContainJoinAndSelectWithListener() {
        ...
        Flow subFlow = (Flow) start.getSuccessors().get(0);
        assertFlow(subFlow, LinkType.NORMAL, 2, 2, 20, 0, 30, start);
        ...
        Action actionE = (Action) subFlow.getSuccessors().get(1);
        assertActivity(actionE, LinkType.FALSE, "actionE", 0, 0, 2, 0, subFlow);
        ...
        assertFlow(flow, LinkType.NORMAL, 0, 2, 6, 0, 10, null);
    }
    ...
    public void testSubThenElseNestedInIfThen() {
        ...
        Flow subFlow1 = (Flow) conditionA.getSuccessors().get(1);
        assertFlow(subFlow1, LinkType.TRUE, 2, 1, 0, 0, 2, conditionA);
        ...
        Action actionD = (Action) subFlow1.getSuccessors().get(1);
        assertActivity(actionD, LinkType.FALSE, "actionD", 0, 0, 0, 0, subFlow1);
    ...
    public void testSubThenElseNestedInIfThenElse() {
        ...
        Flow subFlow2 = (Flow) conditionA.getSuccessors().get(4);
        assertFlow(subFlow2, LinkType.FALSE, 2, 1, 0, 0, 2, conditionA);
        ...
        Action actionH = (Action) subFlow2.getSuccessors().get(0);
        assertActivity(actionH, LinkType.TRUE, "actionH", 0, 0, 0, 0, subFlow2);

        Action actionI = (Action) subFlow2.getSuccessors().get(1);
        assertActivity(actionI, LinkType.FALSE, "actionI", 0, 0, 0, 0, subFlow2);

        Action actionJ = (Action) conditionA.getSuccessors().get(5);
        assertActivity(actionJ, LinkType.FALSE, "actionJ", 0, 0, 0, 0, conditionA);

        assertFlow(flow, LinkType.NORMAL, 0, 8, 0, 0, 12, null);
    }
}
