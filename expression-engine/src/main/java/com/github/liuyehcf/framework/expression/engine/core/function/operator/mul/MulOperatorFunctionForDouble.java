package com.github.liuyehcf.framework.expression.engine.core.function.operator.mul;
 ...
 * @date 2018/9/29
 */
public class MulOperatorFunctionForDouble extends MulOperatorFunction {
    @Override
